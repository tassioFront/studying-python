...
urlpatterns = [
    ...
    path('set-password/', views.UserSetInitialPasswordView.as_view(), name='user-set-initial-password'),
    
    # User self-service profile endpoints (require user authentication)
    path('me/', views.UserProfileView.as_view(), name='user-profile'),
    path('me/password/', views.UserPasswordUpdateView.as_view(), name='user-password-update'),
