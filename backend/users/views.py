...
from .serializers import (
    ...
    UserRegistrationSerializer, UserAuthSerializer, UserPasswordUpdateSerializer,
    UserTokenValidationSerializer, UserInitialPasswordSerializer
)
...
class UserProfileView(generics.RetrieveUpdateAPIView):
    ...
    def get_object(self):
        ...
        if hasattr(self.request.user, '_meta') and self.request.user._meta.app_label == 'users':
